        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li> <a class="nav-link" href="{{ route('product.index') }}"><i class="fas fa-box"></i> Product</a>
                    </li>
                    <li> <a class="nav-link" href="{{ route('customer.index') }}"><i class="fas fa-users"></i>
                            Customer</a>
                    </li>
                    <li> <a class="nav-link" href="{{ route('supplier.index') }}"><i class="fas fa-truck"></i>
                            Supplier</a>
                    </li>
                </ul>
            </li>
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li> <a class="nav-link" href="{{ route('penjualan.index') }}"><i class="fas fa-shopping-cart"></i>
                            Penjualan</a>
                    </li>
                    <li> <a class="nav-link" href="{{ route('pembelian.index') }}"><i
            ...
            <li class="nav-item ">
                <a class="nav-link" href="{{ route('utang.index') }}"><i class="fas fa-money-check"></i>
                    <span>Utang</span></a>
            </li>
            <li class="nav-item ">
                <a class="nav-link" href="{{ route('piutang.index') }}"><i class="fas fa-money-check-alt"></i>
                    <span>Piutang </span> </a>
            </li>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li> <a class="nav-link" href="{{ route('metode_pembayaran.index') }}"><i
                                class="fas fa-university"></i> Akun Bank</a>
                    </li>
                    <li> <a class="nav-link" href="{{ route('jenis_transaksi.index') }}"><i
