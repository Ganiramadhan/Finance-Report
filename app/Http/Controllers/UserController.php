...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user.index', compact('chart_pengeluaran', 'laba_bersih', 'total_laba_kotor', 'total_penjualan', 'sisa_utang', 'sisa_piutang', 'metode_pembayaran', 'penjualanData', 'data_penjualan', 'data_product', 'total_laba_kotor', 'laba_kotor_per_product', 'total_pembelian'));
    }
}
